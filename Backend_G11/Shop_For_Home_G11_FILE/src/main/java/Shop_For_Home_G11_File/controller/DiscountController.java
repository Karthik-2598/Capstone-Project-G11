...
import Shop_For_Home_G11_File.entity.Discount;
import Shop_For_Home_G11_File.helper.ResponseMessage;
...
public class DiscountController {
	...
	public ResponseEntity<ResponseMessage> createCoupon(@PathVariable("code") String code,@RequestBody List<String> emails) {
    	...
    	String url="http://localhost:8081/c1g11/add/coupon/"+code;
    ...
    public List<Discount> orderList() {
    	...
    	String url="http://localhost:8081/c1g11/coupon/alllist";
	...
	public ResponseEntity<Discount> deleteCoupon(@PathVariable("code") Long code) {
    	...
    	String url="http://localhost:8081/c1g11/delete/coupon/"+code;
